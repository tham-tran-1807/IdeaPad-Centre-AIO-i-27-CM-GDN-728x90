...
lib.ssMetadata = [
		{name:"IdeaPad_Centre_AIO_i_27_CM_GDN_728x90_atlas_1", frames: [[738,368,50,50],[0,0,728,90],[698,460,322,90],[434,276,399,90],[359,460,337,90],[0,460,357,90],[0,368,371,90],[0,276,432,90],[373,368,363,90],[0,92,711,90],[0,184,711,90]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["IdeaPad_Centre_AIO_i_27_CM_GDN_728x90_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.IdeaPadCentreAIOi27CMGDN728x90 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(363).call(this.frame_363).wait(27));
	...
	this.timeline.addTween(cjs.Tween.get(this.btn_replay).wait(362).to({_off:false},0).wait(28));
	...
	this.timeline.addTween(cjs.Tween.get(this.mc_mui_ten_xoay).wait(350).to({_off:false},0).to({y:10.45},12).wait(28));
	...
	this.instance_2.setTransform(205,0);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(300).to({_off:false},0).to({_off:true},49).wait(41));

	// f6
	this.instance_3 = new lib.f6();
	this.instance_3.setTransform(150,0);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(249).to({_off:false},0).to({_off:true},51).wait(90));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(199).to({_off:false},0).to({_off:true},50).wait(141));

	// f4
	this.instance_5 = new lib.f4();
	this.instance_5.setTransform(191,0);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(150).to({_off:false},0).to({_off:true},49).wait(191));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(99).to({_off:false},0).to({_off:true},51).wait(240));

	// f2
	this.instance_7 = new lib.f2();
	this.instance_7.setTransform(203,0);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(50).to({_off:false},0).to({_off:true},49).wait(291));
...
// library properties:
lib.properties = {
	id: '0846F3BC45025941A797040ECAD404D9',
	width: 728,
	height: 90,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/IdeaPad_Centre_AIO_i_27_CM_GDN_728x90_atlas_1.png", id:"IdeaPad_Centre_AIO_i_27_CM_GDN_728x90_atlas_1"}
	],
	preloads: []
};
...
an.compositions['0846F3BC45025941A797040ECAD404D9'] = {
